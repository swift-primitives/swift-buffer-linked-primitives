...
extension Buffer.Linked.Small where Element: ~Copyable {
    public enum Insert {
        public typealias View = Property<Buffer<Element>.Linked<N>.Insert, Buffer<Element>.Linked<N>.Small<inlineCapacity>>.Inout.Typed<Element>.Valued<N>.Valued<inlineCapacity>
    }

    public enum Remove {
        public typealias View = Property<Buffer<Element>.Linked<N>.Remove, Buffer<Element>.Linked<N>.Small<inlineCapacity>>.Inout.Typed<Element>.Valued<N>.Valued<inlineCapacity>
    }
}
    ...
    Element: ~Copyable
{
    ...
    public mutating func front(
        ...
        base.value._insertFront(element)
    }
    ...
    public mutating func back(
        ...
        base.value._insertBack(element)
    }
}
