...
extension Buffer.Linked where Element: ~Copyable {
    ...
    public enum Insert {
        public typealias View = Property<Insert, Buffer<Element>.Linked<N>>.Inout.Typed<Element>.Valued<N>
    }

    /// Tag type for `.remove` property extensions.
    public enum Remove {
        public typealias View = Property<Remove, Buffer<Element>.Linked<N>>.Inout.Typed<Element>.Valued<N>
    }
}

// MARK: - Property.Inout.Typed.Valued (.insert, .remove)
...
extension Buffer.Linked where Element: ~Copyable {
    ...
    @inlinable
    mutating func _growTo(_ minimumCapacity: Index<Node>.Count) throws(Self.Error) {
    ...
    /// - Complexity: O(n) where n is the number of elements.
    @inlinable
    public mutating func ensureCapacity(_ minimumCapacity: Index<Node>.Count) throws(Self.Error) {
    ...
    @inlinable
    public mutating func ensureCapacity(_ minimumCapacity: Int) throws(Self.Error) {
    ...
    /// - Complexity: O(n) where n is the number of elements (if growth occurs).
    @inlinable
    public mutating func reserveAdditionalCapacity(_ additional: Index<Node>.Count) throws(Self.Error) {
