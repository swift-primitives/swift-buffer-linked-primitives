...
public typealias DoublyLinkedShared<E> =
    Buffer<Shared<Node<E, 2>, Storage<Memory.Allocator<Memory.Heap>.Pool>.Generational<Node<E, 2>>>>.Linked<2>

/// The singly-linked `Shared` (CoW value-semantic) heap column.
public typealias SinglyLinkedShared<E> =
    Buffer<Shared<Node<E, 1>, Storage<Memory.Allocator<Memory.Heap>.Pool>.Generational<Node<E, 1>>>>.Linked<1>
